...
<body>
	<header class="main">
		...
		<p>
			<a href="http://www.tradezone.fr">Accueil</a>
		</p>
	</header>
	<div class="page">
		<?php
		...
		<footer class="sub">
			<article class="hbox">
				...
				<div class="article_body">
					<p>
						2048 est un jeu de puzzle devenu populaire sur les smartphones.
						<br/><br/>
						Il consiste à assembler des pavés similaires qui apparaissent sur une grille pour en former des plus gros.
						<br/>
						Les pavés peuvent apparaîtrent par deux ou par 4, et vous pouvez les déplacer dans une direction en utilisant
						la manette directionnelle situé sur la droite du jeu. A chaque fois que vous effectuez un déplacement
						un nouveau pavé apparait à un emplacement aléatoire.
						<br/>
						Vous perdez si vous ne pouvez effectuer aucun mouvement
						<br/>
						Votre score augmente à chaque fois que vous unissez deux pavés ensembles, de la valeur du pavé unifié.
						<br/>
						L'objectif est que votre score atteigne 2048.
						<br/><br/>
						Bonne chance !
						<br/>
			...
			<article class="hbox">
				...
				<div class="article_body">
					<p>
						...
						Féliciations !
						<br/>
						Nous n'avions pas prévu cela mais il semblerait que vous soyez meilleur que prévu !
						<br/>
						Peut-être 
						<br/><br/>
						Au fait, avez vous trouvez l'oeuf de pâques ? Je pense que cela en vaut la peine !
						<br/><br/>
						Merci d'avoir joué sur <a href="http://www.tradezone.fr">TradeZone.fr</a>
						<br/><br/>
						Ce jeu à été créé par Darkxell et adapté par shorty
					</p>
				</div>
				<div class="hidden"><br/></div>
			</article>
			...
			<article class="hbox">
				...
				<div class="article_body">
					<p>
						Hum... Il semblerait que vous ayez triché pour gagner !
						<br/><br/>
						Féliciations
						<br/>
						Nous n'avions pas prévu cela mais peut-être que vous êtes moins bon que prévu !
						<br/>
						Peut-être... 
						<br/><br/>
						Peut-être que vous devrier vous pencher sérieusement sur le jeu à présent.
						<br/><br/>
						Merci quand même d'avoir triché avec nous !
						<br/><br/>
						Cliquez <a href="">ici</a> pour commencer un nouveau jeu.
					</p>
				</div>
				<div class="hidden"><br/></div>
			</article>
		...
		?>
		<p class="easteregg">
			Vous avez trouvé un oeuf de pâques. Quelle chance !
		</p>
		<header class="sub">
			<br/>
			<span class="title">
			...
			<span class="new">
				<a href="2048.php">Nouvelle partie</a>
			</span>
		</header>
		<footer>
			<article class="textbox">
				...
				<div class="article_body">
					<p>
						...
						<br/><br/>
						Désolé, peut-être que vous serez meilleurs la prochaine fois !!
						Merci d'avoir essayé !
						<br/>
						Merci de faire connaitre ce jeu à vos amis
						<br/><br/><br/>
						et dites leur de venir s'inscrire sur <a href="http://www.tradezone.fr">TradeZone.fr</a> !
						<br/><br/>
					</p>
				</div>
				<div class="hidden"><br/></div>
		...
		?>
		<p class="easteregg">
			Oui l'oeuf de pâques est toujours là, rien de ne vous échappe...
		</p>
		<header class="sub">
			<br/>
			<span class="title">
			...
			<span class="new">
				<a href="2048.php?score=<?php echo($_GET["score"]."&".gettiles()) ; ?>">Continuer</a>
			</span>
		</header>
	...
	<footer class="main">
		<p>
			Code by <a href="https://github.com/Darkxell/2048-in-php">>Darkxell</a>, adapted by <a href="http://www.tradezone.fr">shorty</a>.
		</p>
	</footer>
</body>
<!--
